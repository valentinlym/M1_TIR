...
#let project(
  ...
  let author_running = "Squad newSmile"
  // let author_running = "🁢🁢🁢"
  ...
  set page(header: context {
    ...
    align(alignment)[
      // directement sans .at(loc)
      #if calc.rem(loc.page(), 2) == 1 {
        "Gamification pour l'apprentissage de langue étrangère"
        h(1cm)
  ...
  set table(
      stroke: (x, y) => if y > 1 { (top: 0pt,x: 0.03em, y: 0.03em) } else { (0.03em) }, inset: .40em)
  ...
  if bibliography-file != none {
    ...
    bibliography(bibliography-file, title: text(12pt)[Références], style: "springer-lecture-notes-in-computer-science")
  }
}
